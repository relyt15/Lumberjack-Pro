package com.example.lumberjackpro;
...
public class TaskPane extends HBox {
    ...
    //this ia the strikethrouh function//
    private void updateTaskStyle() {
        String style = task.isTaskCompleted()
                ? "-fx-strikethrough: true; -fx-text-fill: gray;"
                : "-fx-strikethrough: false; -fx-text-fill: black;";

        nameLabel.setStyle("-fx-font-weight: bold;" + style);
